...
export class VoteNFT__projectsResult {
  value0: string;
  value1: string;
  value2: BigInt;
...
export class VoteNFT extends ethereum.SmartContract {
  static bind(address: Address): VoteNFT {
    return new VoteNFT("VoteNFT", address);
  }
  ...
  createProjNFTCard(uri: string): BigInt {
    let result = super.call(
      "createProjNFTCard",
      "createProjNFTCard(string):(uint256)",
  ...
  try_createProjNFTCard(uri: string): ethereum.CallResult<BigInt> {
  ...
  maxId(): BigInt {
    let result = super.call("maxId", "maxId():(uint256)", []);

    return result[0].toBigInt();
  }

  try_maxId(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("maxId", "maxId():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  projects(param0: BigInt): VoteNFT__projectsResult {
    let result = super.call(
      "projects",
      "projects(uint256):(string,string,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );

    return new VoteNFT__projectsResult(
      result[0].toString(),
      result[1].toString(),
      result[2].toBigInt()
    );
  ...
  try_projects(param0: BigInt): ethereum.CallResult<VoteNFT__projectsResult> {
    let result = super.tryCall(
      "projects",
      "projects(uint256):(string,string,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
...
export class __voteNFT_initCall extends ethereum.Call {
  get inputs(): __voteNFT_initCall__Inputs {
    return new __voteNFT_initCall__Inputs(this);
  }

  get outputs(): __voteNFT_initCall__Outputs {
    return new __voteNFT_initCall__Outputs(this);
  }
}

export class __voteNFT_initCall__Inputs {
  _call: __voteNFT_initCall;

  constructor(call: __voteNFT_initCall) {
    this._call = call;
  }
...
export class __voteNFT_initCall__Outputs {
  _call: __voteNFT_initCall;
...
export class __voteNFT_init_unchainedCall extends ethereum.Call {
  get inputs(): __voteNFT_init_unchainedCall__Inputs {
    return new __voteNFT_init_unchainedCall__Inputs(this);
  }

  get outputs(): __voteNFT_init_unchainedCall__Outputs {
    return new __voteNFT_init_unchainedCall__Outputs(this);
  }
}

export class __voteNFT_init_unchainedCall__Inputs {
  _call: __voteNFT_init_unchainedCall;

  constructor(call: __voteNFT_init_unchainedCall) {
    this._call = call;
  }
...
export class __voteNFT_init_unchainedCall__Outputs {
  _call: __voteNFT_init_unchainedCall;
...
export class CreateProjNFTCardCall extends ethereum.Call {
  get inputs(): CreateProjNFTCardCall__Inputs {
    return new CreateProjNFTCardCall__Inputs(this);
  }

  get outputs(): CreateProjNFTCardCall__Outputs {
    return new CreateProjNFTCardCall__Outputs(this);
  }
}

export class CreateProjNFTCardCall__Inputs {
  _call: CreateProjNFTCardCall;

  constructor(call: CreateProjNFTCardCall) {
    this._call = call;
  }
...
export class CreateProjNFTCardCall__Outputs {
  _call: CreateProjNFTCardCall;
